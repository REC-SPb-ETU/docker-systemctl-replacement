...
class Systemctl:
    ...
    def system_daemon_reload(self):
        ...
        if os.path.exists("/lib/systemd/system/system-generators/postgresql-generator"):
            isExists = os.path.exists("/lib/systemd/system/postgresql.service.wants/postgresql@9.6-main.service")
            if not isExists:
                os.system("run-parts --regex '^p' /lib/systemd/system-generators/ -a /lib/systemd/system/")
        errors = 0
